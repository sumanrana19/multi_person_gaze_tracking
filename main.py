...
class DualPersonGazeTracker:
    ...
    def initialize_system(self):
        """Initialize the system and load necessary data"""
        ...
        # Initialize database
        if not self.db_manager.initialize_database_tables():
    ...
    def capture_attendance(self, duration=ATTENDANCE_DURATION):
        """Phase 1: Capture attendance for specified duration"""
    ...
    def run(self):
        ...
        try:
            ...
            # Phase 5: Dual Gaze Tracking
            gaze_df = self.dual_gaze_tracking(selected_people)
            
            # Phase 6: Analyze attentiveness for both people
